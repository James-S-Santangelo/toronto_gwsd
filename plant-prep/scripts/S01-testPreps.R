...
torPlants <- read_csv("resources/library-preps/03_allPlants_Toronto_allData.csv") %>% 
  filter(!is.na(Qubit_conc)) %>% 
  mutate(plant_id = paste(Population, Plant, sep = "_"))

# Load plants to library prep
allPlant_toPrep <- read_csv("resources/library-preps/04_allPlants_toPrep.csv")
...
write_csv(testPrep, path = "resources/library-preps/optimizing-testing/01_testPrep_plants.csv", col_names = TRUE)
...
write_csv(bioruptor_timeCourse, path = 'resources/library-preps/optimizing-testing/bioruptor_timeCourse.csv', col_names = TRUE)
...
write_csv(testPlants_02, path = 'resources/library-preps/optimizing-testing/02-03_testPrep_plants.csv', col_names = TRUE)
...
write_csv(testPlants_04, path = 'resources/library-preps/optimizing-testing/04_testPrep_plants.csv', col_names = TRUE)
...
write_csv(SKtestPlants, path = 'resources/library-preps/optimizing-testing/05_SK_testPrep_plants.csv', 
          col_names = TRUE)
