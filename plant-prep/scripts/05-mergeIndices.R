...
lane1 <- read_csv("resources/library-preps/pooling/GWSD_Toronto_Lane1.csv")
lane2 <- read_csv("resources/library-preps/pooling/GWSD_Toronto_Lane2.csv")

# Load dataframes with indices
i5_indices <- read_csv("resources/reference/indices/iTru5_forward-indices.csv") %>% 
  rename("i5_index" = "Primer_Name") %>% 
  select(i5_index, Primer_Index_Sequence)
i7_indices <- read_csv("resources/reference/indices/iTru7_reverse-indices.csv") %>% 
...
write_csv(lane1_out, path = "resources/library-preps/pooling/GWSD_Toronto_lane1_withIndices.csv")
write_csv(lane2_out, path = "resources/library-preps/pooling/GWSD_Toronto_lane2_withIndices.csv")
