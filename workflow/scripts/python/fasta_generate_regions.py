...
# NOTE: I downloaded this script from the freebayes GitHub repository for use in this pipeline
# https://github.com/freebayes/freebayes/blob/master/scripts/fasta_generate_regions.py
# The script was downloaded on Aug. 4, 2021. 
# This was necessary since the script is not yet included in an official freebayes release
