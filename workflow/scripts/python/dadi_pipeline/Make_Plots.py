...
snps = '/scratch/projects/trifolium/gwsd/results/dadi/Urban_Rural_dadi_formatted.sfs'
...
from Models_2D import split_no_mig
...
emp_params = [0.8503, 1.0487, 0.0102]
...
model_fit = Plotting_Functions.Fit_Empirical(fs, pts, prefix, "split_no_mig", split_no_mig, emp_params, fs_folded=True)
...
#empirical fit).
Plotting_Functions.Plot_2D(fs, model_fit, prefix, "split_no_mig")
...
vmin = float(0.01)
Plotting_Functions.Plot_2D(fs, model_fit, prefix, "split_no_mig_vmin0.01", vmin_val = vmin)
vmin = float(0.5)
Plotting_Functions.Plot_2D(fs, model_fit, prefix, "split_no_mig_vmin0.5", vmin_val = vmin)
vmin = float(1)
Plotting_Functions.Plot_2D(fs, model_fit, prefix, "split_no_mig_vmin1", vmin_val = vmin)
