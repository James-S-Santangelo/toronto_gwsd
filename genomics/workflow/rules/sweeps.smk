...
rule outlier_analysis:
    ...
    output:
        ...
        xpnsl_manhat_persite_png = f"{FIGURES_DIR}/selection/manhattan/urban_rural_xpnsl_persite_manhat.png",
        ...
        xpnsl_df = f"{FIGURES_DIR}/analyses/outliers/xpnsl_outliers.txt",
        ...
        rur_nsl_manhat_persite = f"{FIGURES_DIR}/selection/manhattan/rural_nSL_persite_manhat.pdf",
        urb_nsl_manhat_persite = f"{FIGURES_DIR}/selection/manhattan/urban_nSL_persite_manhat.pdf",
        rur_nsl_manhat_persite_png = f"{FIGURES_DIR}/selection/manhattan/rural_nSL_persite_manhat.png",
        urb_nsl_manhat_persite_png = f"{FIGURES_DIR}/selection/manhattan/urban_nSL_persite_manhat.png",
        nsl_df = f"{FIGURES_DIR}/analyses/outliers/nsl_outliers.txt",
        ...
        rur_ihs_manhat_persite = f"{FIGURES_DIR}/selection/manhattan/rural_iHS_persite_manhat.pdf",
        urb_ihs_manhat_persite = f"{FIGURES_DIR}/selection/manhattan/urban_iHS_persite_manhat.pdf",
        rur_ihs_manhat_persite_png = f"{FIGURES_DIR}/selection/manhattan/rural_iHS_persite_manhat.png",
        urb_ihs_manhat_persite_png = f"{FIGURES_DIR}/selection/manhattan/urban_iHS_persite_manhat.png",
        ihs_df = f"{FIGURES_DIR}/analyses/outliers/ihs_outliers.txt",
        ...
        rur_ihh12_manhat_persite_png = f"{FIGURES_DIR}/selection/manhattan/rural_iHH12_persite_manhat.png",
        urb_ihh12_manhat_persite_png = f"{FIGURES_DIR}/selection/manhattan/urban_iHH12_persite_manhat.png",
        ihh12_df = f"{FIGURES_DIR}/analyses/outliers/ihh12_outliers.txt",
